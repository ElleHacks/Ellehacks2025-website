    ...
    <div className="mt-20 font-[Faustina] h-auto px-4 mx-auto lg:mx-20 xl:mx-64 mb-32 select-none w-full max-w-screen-xl">
      ...
      <div className="mb-8">
        <div className="flex flex-col gap-4 mb-8 items-center justify-center">
          <div className="w-full h-28 lg:h-40 md:h-36 sm:h-28 bg-white rounded-full border-4 border-gray-300 flex justify-center items-center">
          ...
          <div className="w-full h-28 lg:h-40 md:h-32 sm:h-28 bg-white rounded-full border-4 border-gray-300 flex justify-center items-center">
            <a href="https://www.york.ca/" target="_blank" rel="noreferrer">
              <img src={YorkRegion} alt="YorkRegion" className="h-20 sm:h-28 object-contain" />
            </a>
          </div>
        </div>
      </div>
      ...
      { /* Bronze Sponsors */}
      <div className="mb-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4 mb-8 justify-items-center place-items-center">
      ...
      { /* Community Sponsors */}
      <div className="mb-8">
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mb-8 justify-items-center place-items-center">

          <div className="w-full h-14 sm:h-22 bg-white bg-white rounded-full border-4 border-emerald-800 flex justify-center items-center">
          ...
          <div className="w-full h-14 sm:h-22  bg-white bg-white rounded-full border-4 border-emerald-800 flex justify-center items-center">
            <a href="https://www.levelupreality.ca/" target="_blank" rel="noreferrer">
              <img src={LevelUp} alt="Community Sponsor" className="h-8 md:h-10 object-contain" />
            </a>
          </div>
          <div className="w-full h-14 sm:h-22  bg-white bg-white rounded-full border-4 border-emerald-800 flex justify-center items-center">
          ...
          <div className="w-full h-14 sm:h-22  bg-white bg-white rounded-full border-4 border-emerald-800 flex justify-center items-center">
            <a href="https://www.zebrarobotics.com/" target="_blank" rel="noreferrer">
              <img src={ZebraRobotics} alt="ZebraRobotics" className="h-8 object-contain" />
            </a>
          </div>
          ...
          <div className="w-full h-14 sm:h-22  bg-white bg-white rounded-full border-4 border-emerald-800 flex justify-center items-center">
            <a href="https://nordpass.com/" target="_blank" rel="noreferrer">
              <img src={Nordpass} alt="Nordpass" className="h-8 object-contain" />
            </a>
          </div>
          ...
          <div className="w-full h-14 sm:h-22  bg-white bg-white rounded-full border-4 border-emerald-800 flex justify-center items-center">
            <a href="https://incogni.com/" target="_blank" rel="noreferrer">
              <img src={Icogni} alt="Icogni" className="h-8 object-contain" />
            </a>
          </div>
