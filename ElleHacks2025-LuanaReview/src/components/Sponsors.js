    ...
    <div className="mt-20 font-[Faustina] h-auto px-4 mx-auto lg:mx-20 xl:mx-64 mb-32 select-none w-full max-w-screen-xl">
      ...
      <div className="mb-8">
        ...
        <div className="flex flex-wrap gap-4 mb-8 justify-center">
          <div className="w-80 h-50 md:w-64 md:h-96 bg-white rounded-full flex justify-center items-center">
            <img src={KPM} alt="Bronze Sponsor" className="h-20 sm:h-32 object-contain" />
          </div>
        </div>
      </div>
      <div className="mb-8">
        ...
        <div className="flex flex-wrap gap-4 mb-8 justify-center">
          <div className="w-32 h-20 md:w-64 sm:h-32 bg-white rounded-full flex justify-center items-center">
